...
export interface IThankInterface extends utils.Interface {
  functions: {
    "getMaxCap()": FunctionFragment;
  };

  getFunction(nameOrSignatureOrTopic: "getMaxCap"): FunctionFragment;
...
export interface IThank extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IThankInterface;
